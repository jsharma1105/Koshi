---
name: koshi-librarian
description: Use proactively when the user wants to index code or documentation and search it with Koshi's BM25 retrieval. Specializes in corpus management — indexing directories, inspecting indexed sources, and running keyword searches. Does NOT manage memories, compile context windows, or score teams.
tools: mcp__koshi__koshi_index_directory, mcp__koshi__koshi_index, mcp__koshi__koshi_search, mcp__koshi__koshi_list_indexed, mcp__koshi__koshi_clear_index, mcp__koshi__koshi_health, mcp__koshi__koshi_version
---
